                ...
                <div className="h-full">
                    <div className="chartjs-size-monitor">
                        <div className="chartjs-size-monitor-expand">
                            <MapContainer center={[-26.205, 28.049722]} zoom={7} haveUsersLocation={false}
                      ...
                      marginbottom: "90px",
                                ...
                                <Marker key={location.id} icon={ICON} position={[location.latitude,
                                    location.longitude]}>
                                    <Popup>
                                        ...
                                        {location.severity === "High" || location.severity === "high" ? (
                                        <p style={{ color: "red" }}>{location.severity}</p>
                                        ) : location.severity === "Low" || location.severity === "low" ? (
