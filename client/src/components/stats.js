      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-3 mb-6">
          ...
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div className="widget-label">
                <h3 className="text-gray">Low severity incidents</h3>
                <h1>{low}</h1>
              </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div className="widget-label">
                <h3 className="text-success">Medium severity incidents</h3>
                <h1>{medium}</h1>
              </div>
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center justify-between">
              <div className="widget-label">
                <h3 className="text-danger">High severity incidents</h3>
                <h1>{high}</h1>
              </div>
